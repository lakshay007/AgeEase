...
<main class="flex flex-row grow h-full w-full justify-around items-center">
    <div class=" grow h-full w-1/2 flex flex-col justify-center items-center gap-y-10">
    ...
    <div class="grow h-full w-1/2 flex justify-center items-center rounded-r-2xl bg-[#eeeeee] ">
        b
    </div>
</main>